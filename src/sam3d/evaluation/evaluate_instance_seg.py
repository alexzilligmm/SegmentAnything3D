...
import sam3d.evaluation.util as util
import sam3d.evaluation.util_3d as util_3d
        ...
        for oi, overlap_th in enumerate(overlaps):
            ...
            for li, label_name in enumerate(CLASS_LABELS):
                ...
                if has_gt and has_pred:
                    ...
                    num_true_examples = y_true_sorted_cumsum[-1] if y_true_sorted_cumsum.size > 0 else 0
